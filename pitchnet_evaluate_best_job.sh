...
OUTDIR='/saved_models/arch_0628/PND_v04_JWSS_ANlowpass0050Hz_classification'$SLURM_ARRAY_TASK_ID
TFRECORDS_REGEX='cf100_species002_spont070_lowpass0050Hz/*.tfrecords'
