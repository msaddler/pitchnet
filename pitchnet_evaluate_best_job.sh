...
-de "/om/user/msaddler/data_pitchnet/oxenham2004/Oxenham2004_transposedTones_f0_080to320Hz_dense4x/$TFRECORDS_REGEX" \
-efn "${EFN_PREFIX}oxenham2004_080to320Hz_dense4x_bestckpt.json" \
-o "$OUTDIR" \
-wpo $WRITE_PROBS_OUT
