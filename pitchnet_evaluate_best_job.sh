...
/om2/user/msaddler/singularity-images/tfv1.13_unet.simg \
python pitchnet_evaluate_best.py \
-de "/om/user/msaddler/data_pitchnet/oxenham2004/Oxenham2004_transposedTones_f0_080to320Hz_v02/$TFRECORDS_REGEX" \
-efn "${EFN_PREFIX}oxenham2004_080to320Hz_v02_bestckpt.json" \
-o "$OUTDIR" \
-wpo $WRITE_PROBS_OUT
