...
OUTDIR='/saved_models/arch_0628/PND_v04_TLAS_AN_BW10eN1_IHC0050Hz_classification'$SLURM_ARRAY_TASK_ID
SAVED_MODELS_PATH="/om2/user/msaddler/pitchnet/saved_models"

TFRECORDS_REGEX='cf100_species002_spont070_BW10eN1_IHC0050Hz_IHC7order/*.tfrecords'
