...
OUTPUT_DIR_PATTERN="/saved_models/arch_search_v01_spont070_BW10eN1_IHC9000Hz_IHC7order/arch_{:04d}"
OUTPUT_LOG_FN=$(printf "$SCRATCH_PATH/pitchnet/saved_models/arch_search_v01_spont070_BW10eN1_IHC9000Hz_IHC7order/logs_train/arch_%04d.log" ${job_idx})
...
-c "${SOURCE_CONFIG_FN}" \
-j ${job_idx} \
-dt /data/PND_v08/noise_TLAS_snr_neg10pos10/sr20000_cf100_species002_spont070_BW10eN1_IHC9000Hz_IHC7order/bez2018meanrates_0[0-7]*.tfrecords \
-de /data/PND_v08/noise_TLAS_snr_neg10pos10/sr20000_cf100_species002_spont070_BW10eN1_IHC9000Hz_IHC7order/bez2018meanrates_0[8-9]*.tfrecords \
