...
OUTDIR_REGEX='/om2/user/msaddler/pitchnet/saved_models/arch_search_v02_topN/REDOsr2000_cfI*_species002_spont070_BW10eN1_IHC0050Hz_IHC7order/arch_????'
...
# /om2/user/msaddler/singularity-images/tfv1.13_unet.simg \
# python /om2/user/msaddler/pitchnet/assets_psychophysics/f0dl_generalized.py \
# -r "${OUTDIR_REGEX}/${EFN_PREFIX}testspl_v02_bestckpt.json" \
# -k 'dbspl' \
# -p ${PRIOR_RANGE} \
# -j ${job_idx}
