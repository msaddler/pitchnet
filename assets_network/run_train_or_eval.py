...
def run_train_or_eval(
        ...
        migrate_config=True):
    """
    Wrapper function to run the training or evaluation routine
    ...
    if eval_only_mode:
        ...
        if migrate_config:
            ...
            config_filename_to_load = fph.migrate_config_to_new_output_directory(
                config_filename,
                output_directory,
    ...
    # ===================================================================================================== #
        ...
        for key in results_dict.keys():
            if type(results_dict[key]) == list:
                print('|___', key, np.array(results_dict[key]).shape)
            else:
                print('|___', key, results_dict[key], type(results_dict[key]))
...
if __name__ == "__main__":
    ...
    if eval_only_mode:
        print('EVALUATION OUTPUT:', os.path.join(args.outputdir, args.eval_output_fn))
