...
source_regex="$SCRATCH_PATH"'/data_pitchnet/PND_v08/noise_TLAS_snr_neg10pos10/sr20000_cf100_species004_spont070_BWlinear_IHC3000Hz_IHC7order/bez2018meanrates*.hdf5'
# source_regex='/om/user/msaddler/data_pitchnet/*/*v01*/sr20000_cf100_species004_spont070_BWlinear_IHC3000Hz_IHC7order/*.hdf5'
