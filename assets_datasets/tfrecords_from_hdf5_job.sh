...
source_regex="$SCRATCH_PATH"'/data_pitchnet/PND_v04/noise_TLAS_snr_neg10pos03/cf100_species002_spont070_BW10eN1_IHC5000Hz_IHC7order/bez2018meanrates_*.hdf5'
