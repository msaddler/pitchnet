...
source_regex="$SCRATCH_PATH"'/data_pitchnet/PND_v08/noise_TLAS_snr_posInf/sr20000_cf100_species002_spont070_BW10eN1_IHC3000Hz_IHC7order/bez2018meanrates*.hdf5'
