...
source_regex='/om/user/msaddler/data_pitchnet/mcpherson2020/testsnr_v02/sr20000_cf100_species002_spont070_BW*eN1_IHC3000Hz_IHC7order/bez2018meanrates*.hdf5'
