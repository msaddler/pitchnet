...
# source_regex="$SCRATCH_PATH"'/data_pitchnet/PND_v08/noise_TLAS_snr_neg10pos10/sr20000_cf100_species002_spont070_BW10eN1_IHC3000Hz_IHC7order_flat_exc/bez2018meanrates*.hdf5'
...
source_regex='/om/user/msaddler/data_pitchnet/*/*/sr20000_cf100_species002_spont070_BW10eN1_IHC3000Hz_IHC7order_flat_exc/*.hdf5'
