...
source_regex="$SCRATCH_PATH"'/data_pitchnet/PND_mfcc/negatedPNDv08_snr_neg10pos10_phase0/*.hdf5'
dest_filename="$SCRATCH_PATH"'/data_pitchnet/PND_mfcc/negatedPNDv08_snr_neg10pos10_phase0/sr20000_cf100_species002_spont070_BW10eN1_IHC3000Hz_IHC7order/bez2018meanrates.hdf5'
