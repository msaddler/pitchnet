...
source_regex="$SCRATCH_PATH"'/data_pitchnet/PND_v04/noise_JWSS_snr_neg10pos03/PND_sr32000_v04*.hdf5'
dest_filename="$SCRATCH_PATH"'/data_pitchnet/PND_v04/noise_JWSS_snr_neg10pos03/cf100_species002_spont070_lowpass0320Hz/bez2018meanrates.hdf5'
# source_regex='/om/user/msaddler/data_pitchnet/oxenham2004/Oxenham2004_transposedTones_f0_080to320Hz/*.hdf5'
# dest_filename='/om/user/msaddler/data_pitchnet/oxenham2004/Oxenham2004_transposedTones_f0_080to320Hz/cf100_species002_spont070_lowpass0050Hz/bez2018meanrates.hdf5'
s
