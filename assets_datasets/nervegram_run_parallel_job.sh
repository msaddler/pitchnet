...
# source_regex="$SCRATCH_PATH"'/data_pitchnet/PND_v06/noise_TLAS_snr_neg10pos03/PND_sr32000*.hdf5'
# dest_filename="$SCRATCH_PATH"'/data_pitchnet/PND_v06/noise_TLAS_snr_neg10pos03/cf100_species002_spont070/bez2018meanrates.hdf5'
source_regex='/om/user/msaddler/data_pitchnet/bernox2005/FixedFilter_f0min100_f0max300/*.hdf5'
dest_filename='/om/user/msaddler/data_pitchnet/bernox2005/FixedFilter_f0min100_f0max300/cf100_species002_spont070_lowpass0640Hz/bez2018meanrates.hdf5'
...
-d "${dest_filename}" \
-j ${job_idx} \
-jps ${jobs_per_source_file} -lpf '640.0' -sks 'tone_in_noise' -sksr 'config_tone/fs' 
