...
#SBATCH --requeue
#SBATCH --dependency=afterok:17389880

## Define source_regex and dest_filename here (use single quotes to prevent regex from expanding)

source_regex="$SCRATCH_PATH"'/data_pitchnet/PND_mfcc/matchedPNDv08_snr_neg10pos10_phase0/*.hdf5'
dest_filename="$SCRATCH_PATH"'/data_pitchnet/PND_mfcc/matchedPNDv08_snr_neg10pos10_phase0/sr20000_cf100_species002_spont070_BW10eN1_IHC3000Hz_IHC7order/bez2018meanrates.hdf5'
