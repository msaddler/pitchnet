...
def add_f0_label_to_hdf5(hdf5_filename, f0_key='f0', f0_label_key='f0_label',
                         f0_label_dtype=np.int64, f0_bin_kwargs={}):
    '''
...
if __name__ == "__main__":
    ...
    for hdf5_filename in hdf5_fn_list:
        ...
        add_f0_label_to_hdf5(hdf5_filename, f0_key='f0', f0_label_key='f0_label',
                             f0_label_dtype=np.int64, f0_bin_kwargs={})
