...
OUTDIR='/saved_models/arch_search_v02_topN/cochlearn/arch_'$ZPJID
...
DATA_TRAIN='/data/PND_v08/noise_TLAS_snr_neg10pos10/train/*.tfrecords'
DATA_EVAL='/data/PND_v08/noise_TLAS_snr_neg10pos10/valid/*.tfrecords'
