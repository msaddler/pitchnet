...
OUTDIR='/saved_models/models_metamer/arch_0302_PND_v08_TLAS_snr_neg10pos10_filter_signalHPv00_AN_RSB_noise0000_classification'$SLURM_ARRAY_TASK_ID
OUTPUT_LOG_FN='/om2/user/msaddler/pitchnet'$OUTDIR'/output_train.log'
DATA_TRAIN='/data/PND_v08/noise_TLAS_snr_neg10pos10_filter_signalHPv00/sr20000_cf100_species002_spont070_BW10eN1_IHC3000Hz_IHC7order/bez2018meanrates_0[0-7]*.tfrecords'
DATA_EVAL='/data/PND_v08/noise_TLAS_snr_neg10pos10_filter_signalHPv00/sr20000_cf100_species002_spont070_BW10eN1_IHC3000Hz_IHC7order/bez2018meanrates_0[8-9]*.tfrecords'
